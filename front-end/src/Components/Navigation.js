    ...
    <div>
      <div className="wrapper flex justify-between items-center py-5">
        ...
        <div className="hidden lg:flex items-center gap-[30px]">
          ...
          <button className="text-base border-2 border-green-500 rounded-full py-2 px-5 hover:bg-green-500 hover:border-transparent hover:text-white">
            Sign Up
          </button>
        </div>
      ...
      <Drawer
        className="px-6 py-12 rounded-r-lg flex flex-col gap-16 lg:hidden"
        open={open}
        onClose={closeDrawer}
      >
        <IoClose
